...
migrate((db) => {
...

  {
    ...
    collection.indexes = [
    "CREATE UNIQUE INDEX `idx_67SSh6VnWkQVu95_slug` ON `tenants` (`slug`)",
    ];
  {
    ...
    collection.schema = new Schema({});
  {
    ...
    field.initOptions();
    field.options.collectionId = "67SSh6VnWkQVu95";
...

  {
    ...
    collection.schema = new Schema({});
    collection.indexes = [
    "CREATE UNIQUE INDEX `idx_v9QtmZ2GcTe5Nnp_tenant` ON `stripe_connections` (`tenant`)",
    ];
  {
    const field = new SchemaField({
      system: false,
  ...
  {
    const collection = dao.findCollectionByNameOrId("v9QtmZ2GcTe5Nnp");
    dao.deleteCollection(collection);
  }
  {
    const collection = dao.findCollectionByNameOrId("vb7cFKYbUoYNzbV");
    dao.deleteCollection(collection);
  }
  {
    const collection = dao.findCollectionByNameOrId("rYxsD6SlbLwgvCU");
    dao.deleteCollection(collection);
  }
  {
    const collection = dao.findCollectionByNameOrId("PfaC3MEcufUTtOm");
    dao.deleteCollection(collection);
  }
  {
    const collection = dao.findCollectionByNameOrId("67SSh6VnWkQVu95");
    dao.deleteCollection(collection);
  }
});
