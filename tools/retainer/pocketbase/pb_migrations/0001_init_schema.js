...
migrate((db) => {
...

  {
    ...
    collection.indexes = [
    "CREATE UNIQUE INDEX `idx_oRoEeMdIeGJNHWK_slug` ON `tenants` (`slug`)",
    ];
  {
    ...
    collection.schema = new Schema({});
  {
    ...
    field.initOptions();
    field.options.collectionId = "oRoEeMdIeGJNHWK";
...

  {
    ...
    collection.schema = new Schema({});
    collection.indexes = [
    "CREATE UNIQUE INDEX `idx_hulxb9lWOv4JbcB_tenant` ON `stripe_connections` (`tenant`)",
    ];
  {
    const field = new SchemaField({
      system: false,
    ...
    collection.schema = new Schema({});
  {
    ...
    field.initOptions();
    field.options.collectionId = "JV7rR5FZnq6bcAj";
    field.options.cascadeDelete = false;
    field.options.minSelect = null;
    field.options.maxSelect = 1;
    field.options.displayFields = null;
  ...
  {
    const collection = dao.findCollectionByNameOrId("hcOLUSn07GhsTjR");
    dao.deleteCollection(collection);
  }
  {
    const collection = dao.findCollectionByNameOrId("hulxb9lWOv4JbcB");
    dao.deleteCollection(collection);
  }
  {
    const collection = dao.findCollectionByNameOrId("ZimV5guxg4x8EPJ");
    dao.deleteCollection(collection);
  }
  {
    const collection = dao.findCollectionByNameOrId("zGQfNwJs4JXeoSl");
    dao.deleteCollection(collection);
  }
  {
    const collection = dao.findCollectionByNameOrId("JV7rR5FZnq6bcAj");
    dao.deleteCollection(collection);
  }
  {
    const collection = dao.findCollectionByNameOrId("oRoEeMdIeGJNHWK");
    dao.deleteCollection(collection);
  }
});
